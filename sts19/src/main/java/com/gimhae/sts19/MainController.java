...
public class MainController {
	...
	@ResponseBody
	@GetMapping("/token")
	public String getToken() { //HttpServletResponse resp) throws IOException {
//		Cookie cookie = new Cookie("token", jwtService.createToken("user01"));
//		cookie.setMaxAge((int)(System.currentTimeMillis()+6000));
